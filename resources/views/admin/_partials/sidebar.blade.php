        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <li>
                <a href="{{route('admin-list-foundations')}}" :class="url_link.includes('list-foundations') ? 'nav-link-active' : '' " class="nav-link px-0 align-middle">
                    <i class="fa-solid fa-address-book"></i> <span class="ms-1 d-none d-sm-inline">Foundations</span></a>
            </li>
            <li>
                <a href="{{route('admin-list-packages')}}" :class="url_link.includes('list-packages') ? 'nav-link-active' : '' " class="nav-link px-0 align-middle">
                    <i class="fa-solid fa-cube"></i> <span class="ms-1 d-none d-sm-inline">Packages</span></a>
            </li>
            <li>
                <a href="{{route('admin-list-orders')}}" :class="url_link.includes('list-orders') ? 'nav-link-active' : '' " class="nav-link px-0 align-middle">
                    <i class="fa-solid fa-envelope"></i> <span class="ms-1 d-none d-sm-inline">Orders</span></a>
            </li>
            <li>
                <a href="{{route('admin-list-bankings')}}" :class="url_link.includes('list-orders') ? 'nav-link-active' : '' " class="nav-link px-0 align-middle">
                    <i class="fa-solid fa-envelope"></i> <span class="ms-1 d-none d-sm-inline">Banking</span></a>
            </li>
        </ul>
        <hr>
