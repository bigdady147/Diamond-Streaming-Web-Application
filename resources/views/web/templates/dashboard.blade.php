...
@section('content')
    <section id="app" class="diamond-dashboard">
        <section id="banner" class="banner-diamond">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  src="{{ asset('images/banner/nimo.png') }}"  class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img  src="{{ asset('images/banner/bigo.jpg') }}"  class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img  src="{{ asset('images/banner/ec.jpg') }}"  class="d-block w-100" alt="...">
                    </div>
                </div>
...
{{--                 src="https://wp.ditsolution.net/techno/wp-content/uploads/2020/11/slide-image-6.jpg"--}}
{{--                 alt="banner">--}}
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="title-desktop intro-title">
                            <span class="text-pri text-bolder">DỊCH VỤ NẠP KIM CƯƠNG GIÁ RẺ</span>
                            <br>
        ...
        <section id="math" class="math">
            <div class="container">
                <div class="math-title">
                    <h2 class="big-title text-black">CÔNG THỨC CHUYỂN ĐỔI</h2>
                ...
                <div v-show="math_input == 'mico' " class="form-send-request">
                    <div class="form-data">
                        <div class="row">
                            <div class="form-input col-lg-6" >
                                <label id="label_id_mico" for="id_mico">Nhập số tiền:</label>
                                <input class="mt-2" v-model="item_math_mico.money" placeholder="Nhập số tiền" name="id_mico"
                                       id="id_mico"
                                       type="number">
                            </div>
                            <div class="form-input col-lg-6 " >
                                <label id="label_id_mico" for="id_mico">Kim cương:</label>
                                <input class="mt-2" v-model="item_math_mico.diamond" placeholder="Kim cương nhận được" name="id_mico"
                                       id="id_mico" disabled
                                       type="number">
                            </div>
                            <div class="col-lg-12">
                                <div class="send-request">
                                    <button @click="math(math_input,item_math_mico.money)" class="button-send-request">
                                        CHUYỂN ĐỔI
                                    </button>
                                </div>
                            </div>
                ...
                <div v-show="math_input == 'bigo' " class="form-send-request">
                    <div class="form-data">
                        <div class="row">
                            <div class="form-input col-lg-6" >
                                <label id="label_id_bigo" for="id_bigo">Nhập số tiền:</label>
                                <input class="mt-2" v-model="item_math_bigo.money" placeholder="Nhập số tiền" name="id_bigo"
                                       id="id_bigo"
                                       type="number">
                            </div>
                            <div class="form-input col-lg-6 " >
                                <label id="label_id_bigo" for="id_bigo">Kim cương:</label>
                                <input class="mt-2" v-model="item_math_bigo.diamond" placeholder="Kim cương nhận được" name="id_bigo"
                                       id="id_bigo" disabled
                                       type="number">
                            </div>
                            <div class="col-lg-12">
                                <div class="send-request">
                                    <button @click="math(math_input,item_math_bigo.money)" class="button-send-request">
                                        CHUYỂN ĐỔI
                                    </button>
                                </div>
                            </div>
        ...
        <section id="request" class="request">
            <div class="container">
                <div class="request-title">
                    <h2 class="big-title text-black">Gửi yêu cầu nạp Kim Cương</h2>
                ...
                <div class="form-send-request">
                    <div class="form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-item">
                                    <label id="label_id_bigo" for="id_nimo">ID</label>
        ...
        <section id="guide" class="guide">
            <div class="container">
                <div class="guide-title">
                    <h2 class="big-title text-black">HƯỚNG DẪN</h2>
                ...
                <div class="guide-group">
                    <div class="mini-title ">
                        ...
                        <span class="text text-black title-desktop fw-600">Quy trình nạp kim cương giá rẻ</span>
                    </div>
                    <div class="step-guide">
                        <div class="guide-item">
                            ...
                            <div class="text-desktop text-black ">
                                <span class="color-pri-light text-desktop text-bolder">Bước 1:</span> <span
                                    class="text-black text-desktop">Khách hàng gửi yêu cầu nạp vui lòng cung cấp thông tin nick Nimo TV muốn nhận Kim Cương và gói muốn nạp</span>
                            </div>
                        </div>
                        <div class="guide-item">
                            <div class="icon">
                            ...
                            <div class="text-desktop text-black ">
                                <span class="color-pri-light text-desktop text-bolder">Bước 2:</span> <span
                                    class="text-black text-desktop">Sau khi gửi Yêu cầu, quý khách vui lòng nhắn tin cho Zalo hỗ trợ, gửi bill giao dịch chuyển khoản
                            ...
                            <div class="row">
                                <div v-for="(item,index) in list_supporters.data" class="col-lg-6">
                                    <div class="guide-step2-item">
                                        <div class="title text-pri text-bolder text-desktop">
                                            HỖ TRỢ NẠP 1
                                        </div>
                                        <div class="contact">
                                            <span class="icon">
                                                <i class="fa-solid fa-phone text-desktop text-pri"></i>
                                            </span>
                                            <span v-text="'Phone & Zalo: ' + _.get(item,'phone','')"
                                                  class="text-desktop text-black text"></span>
                                        </div>
                                        <div class="group-text">
                                            <div class="group-text-item">
                                                <div class="icon">
                                                    <i class="fa-solid fa-diamond text-desktop text-pri"></i>
                                                </div>
                                                <div class="text-desktop text-black">
                                                    <span
                                                        class="text-black text-desktop ">Nội dung chuyển khoản: </span>
                                                    <span v-text="' [ID tài khoản nhận Kim Cương]. Ví dụ: 123456789'"
                                                          class="text-pri text-desktop"></span>
                                                </div>
                                            </div>
                                            <div class="group-text-item">
                                                <div class="icon">
                                                ...
                                                <div class="text-desktop text-black">
                                                    <span
                                                        class="text-black text-desktop ">STK Ngân Hàng:  </span>
                                                    <span class="text-pri text-desktop"
                                            ...
                                            <div class="group-text-item">
                                                ...
                                                <div class="text-desktop text-black">
                                                    <span
                                                        class="text-black text-desktop ">Chủ Tài Khoản: </span>
                                                    <span
                                                        class="text-pri text-desktop"
                                            ...
                                            <div class="group-text-item">
                                                ...
                                                <div class="text-desktop text-black">
                                                    <span
                                                        class="text-black text-desktop ">Ngân Hàng: </span>
                                                    <span class="text-pri text-desktop"
                        ...
                        <div class="guide-item pt-3">
                            ...
                            <div class="text-desktop text-black ">
                                <span class="color-pri-light text-desktop text-bolder">Bước 3:</span> <span
                                    class="text-black text-desktop"> Quý khách vui lòng chờ phản hồi và đợi Kim Cương về tài khoản</span>
                            </div>
                        </div>
                    </div>
                    <div class="mini-title pt-4">
                        <div class="icon">
                            <div class="num">II</div>
                        </div>
                        <span class="text text-black title-desktop fw-600">Lưu ý khi nạp Kim cương Nimo TV giá rẻ</span>
                    </div>
                    <div class="step-guide">
                        <div class="guide-item">
                            <div class="icon">
                            ...
                            <div class="text-desktop text-black ">
                                <span class="text-black text-desktop">Quý khách nên chọn nạp gói cao để được
                        ...
                        <div class="guide-item">
                            ...
                            <div class="text-desktop text-black ">
                                <span class="color-white text-desktop ">Quý khách có nhu cầu nạp từ <strong
        ...
        <section id="support" class="support">
            <div class="container">
                <div class="support-title">
                    <h2 class="big-title text-black">LIÊN HỆ VÀ HỖ TRỢ</h2>
                    <p class="text-desktop color-dark">Mọi vướng mắc trong quá trình nạp cũng như yêu cầu hỗ trợ vui
                        lòng liên hệ Zalo</p>
                </div>
                            ...
                            <div class="support-item">
                                <div class="support-item-title">
                                    ...
                                    <span v-text="'Hỗ trợ ' + (index + 1) + ' Phone & Zalo'"
                                          class="text-desktop text-white ">Hỗ trợ 1 Phone & Zalo: <strong
        ...
        <section id="service" class="service">
            <div class="container">
                <div class="service-title">
                    <h2 class="big-title text-black">DỊCH VỤ NẠP KIM CƯƠNG GIÁ RẺ ĐẠI LÝ <strong class="text-pri">Dailykimcuong.com</strong></h2>
                    <p class="text-desktop text-dark">Dịch vụ của chúng tôi</p>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div data-bs-toggle="collapse" href="#multi1" role="button" aria-expanded="false"
                                    ...
                                    <span class="text text-desktop text-black fw-600">An toàn</span>
                                    <span class="icon">
                            ...
                            <div class="col-lg-3">
                                <div data-bs-toggle="collapse" href="#multi2" role="button" aria-expanded="false"
                                    ...
                                    <span class="text text-desktop text-black fw-600">Tiết kiệm</span>
                                    <span class="icon">
                            ...
                            <div class="col-lg-3">
                                <div data-bs-toggle="collapse" href="#multi3" role="button" aria-expanded="false"
                                    ...
                                    <span class="text text-desktop text-black fw-600">Uy tín</span>
                                    <span class="icon">
                            ...
                            <div class="col-lg-3">
                                <div data-bs-toggle="collapse" href="#multi4" role="button" aria-expanded="false"
                                    ...
                                    <span class="text text-desktop text-black fw-600">Nhiều ưu đãi</span>
                                    <span class="icon">
                            ...
                            <div class="col-lg-12">
                                <div class="collapse multi-collapse show" id="multi1">
                                    <div class="card card-body data-collapse text text-desktop text-black fw-600">
                                        <span class="color-pri-light fw-600"> An toàn</span>
                                        <span>Kim cương nạp từ đại lý <strong class="color-pri-light">dailykimcuong.com</strong> sẽ tương đương với Kim Cương bạn nạp trực
                                ...
                                <div class="collapse multi-collapse " id="multi3">
                                    <div class="card card-body data-collapse text text-desktop text-black fw-600">
                                        <span class="color-pri-light ">Uy tín</span>
                                ...
                                <div class="collapse multi-collapse " id="multi4">
                                    <div class="card card-body data-collapse text text-desktop text-black fw-600">
                                        <span class="color-pri-light ">Nhiều ưu đãi</span>
        ...
        <section id="infor" class="infor">
            <div class="container">
                <div class="infor-title">
                    <h2 class="big-title text-black">THÔNG TIN</h2>
                ...
                <div class="infor-group">
                    <div class="infor-item">
                        ...
                        <span class="text-desktop text-black">Nạp đại lý Nimo giá rẻ là nạp kim cương
                    ...
                    <div class="infor-item pt-2">
                        ...
                        <span class="text-desktop text-black">Với cách nạp này quý khách sẽ được nạp Kim Cương
...
{{--                            <i class="fa-solid fa-diamond text-desktop color-pri-light"></i>--}}
{{--                        </span>--}}
{{--                        <span class="text-desktop text-black">Hyo Entertainment là Agency chính thức được ủy--}}
...
{{--                    </div>--}}
                    <div class="infor-item pt-2">
                        ...
                        <span class="text-desktop text-black">Đặc biệt sẽ có những ưu đãi dành riêng cho
        ...
        <section id="about-us" class="about-us">
            <div class="container">
                <div class="support-title">
                    <h2 class="big-title text-black">VỀ CHÚNG TÔI</h2>
                    <div class="row align-items-center">
                        <div class="col-lg-9">
                            <div class="text-desktop color-dark">
                        ...
                        <div class="col-lg-3">
                            <div class="img-bct">
                                <img src="{{ asset('images/banner/bct.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    math(key, money_data) {
                        ...
                        switch (key) {
                            case 'nimo':
                                ...
                                break;
                            case 'bigo':
                                if (money > 0 && money < 19800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 570.00);

                                } else if (money >= 19800 && money < 139800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 565.71);

                                } else if (money >= 139800 && money < 399800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 550.39);

                                } else if (money >= 399800 && money < 1199800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 520.57);

                                } else if (money >= 1199800 && money < 1999800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 519.39);

                                } else if (money >= 1999800 && money < 2599800) {
                                    vm.item_math_bigo.diamond = parseInt(money / 505.00);

                                } else if (money >= 2599800 && money < 3980000) {
                                    vm.item_math_bigo.diamond = parseInt(money / 500.25);

                                }else if (money >= 3980000 && money < 19800000) {
                                    vm.item_math_bigo.diamond = parseInt(money / 497.75);

                                }else if (money >= 19800000 && money < 39400000) {
                                    vm.item_math_bigo.diamond = parseInt(money / 495.25);

                                }else if (money >= 39400000 && money < 98000000) {
                                    vm.item_math_bigo.diamond = parseInt(money / 492.75);

                                }else if (money >= 98000000) {
                                    vm.item_math_bigo.diamond = parseInt(money / 490.25);
                                }
                                // code block
                                break;
                            case 'mico':
                                // code block
                                if (money > 0 && money < 19800) {
                                    vm.item_math_mico.diamond = parseInt(money / 230);

                                } else if (money >= 19800 && money < 99800) {
                                    vm.item_math_mico.diamond = parseInt(money / 225.00);

                                } else if (money >= 99800 && money < 199800) {
                                    vm.item_math_mico.diamond = parseInt(money / 224.27);

                                } else if (money >= 199800 && money < 599800) {
                                    vm.item_math_mico.diamond = parseInt(money / 222.00);

                                } else if (money >= 599800 && money < 1179800) {
                                    vm.item_math_mico.diamond = parseInt(money / 220.27);

                                } else if (money >= 1179800 && money < 1799800) {
                                    vm.item_math_mico.diamond = parseInt(money / 211.43);

                                } else if (money >= 1799800 && money < 3980000) {
                                    vm.item_math_mico.diamond = parseInt(money / 210.50);

                                }else if (money >= 3980000 && money < 19800000) {
                                    vm.item_math_mico.diamond = parseInt(money / 209.45);

                                }else if (money >= 19800000 && money < 39400000) {
                                    vm.item_math_mico.diamond = parseInt(money / 208.40);

                                }else if (money >= 39400000 && money < 98000000) {
                                    vm.item_math_mico.diamond = parseInt(money / 207.35);

                                }else if (money >= 98000000) {
                                    vm.item_math_mico.diamond = parseInt(money / 206.26);
                                }
                                break;
                            default:
                            // code block
