...
(function (global, factory) {
  ...
  function hasDomain(value,domain){
    var domain = 'aihr.vn';
    return String(value).endsWith(domain);
  }
  ...
  var messages = {
    ...
    //   confirmed: function (field) { return ("The " + field + " confirmation does not match."); },
      confirmed: function (field) { return ("The " + field +  " confirmation does not match."); },
      hasDomain: function (field) { return ("Please choose a sub " + field +  " that contains the following format: xxx.aihr.vn"); },
      ...
      email: function (field) { return (field + " không đúng định dạng"); },

      confirmPass: function(value1, value2, field){
        if (value2 !== value1) {
      ...
      regex: function (field) { return (field + " không đúng định dạng."); },
      required: function (field) { return (field + " không được để trống."); },
